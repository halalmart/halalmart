...
class Penjualan extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('admin/toko_reseller/transaksi/M_penjualan');
    ...
    function index()
    {
        ...
        $this->load->view('admin/toko_reseller/transaksi/penjualan/v_penjualan', $data);
    ...
    function add()
    {
        ...
        $data['nama'] = $this->M_penjualan->get_pembeli()->result();
        $this->load->view('admin/tempelate/header', $title);
        $this->load->view('admin/tempelate/navbar');
        $this->load->view('admin/tempelate/sidebar');
        $this->load->view('admin/tempelate/wraper');
        $this->load->view('admin/toko_reseller/transaksi/penjualan/v_penjualan_add', $data);
        $this->load->view('admin/tempelate/footer');
    }
    ...
    function edit($id_product)
    {
        ...
        $data['kategori'] = $this->M_penjualan->get_data()->result();
